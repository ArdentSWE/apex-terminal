...
export default function WhaleTape() {
  ...
  if (whales.length === 0) {
    return (
      <div className="w-full bg-black border-y border-white/5 overflow-hidden relative flex items-center justify-center h-12 shrink-0">
  ...
  return (
    <div className="w-full bg-black border-y border-white/5 overflow-hidden relative flex items-center h-12 shrink-0">
